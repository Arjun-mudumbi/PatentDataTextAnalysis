...
#%%%%%%%%%%%555555
vectorizer = TfidfVectorizer(vocabulary=mybigramlist)
...
z1=accuracy_score(ytest, ypred)
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
from sklearn.neighbors import KNeighborsClassifier
classifier= KNeighborsClassifier(n_neighbors=30,algorithm="auto",)
classifier.fit(xtrain,ytrain)
ypred=classifier.predict(xtest)
confusion_matrix(ytest,ypred)
...
classifier= LogisticRegression(solver="newton-cg",multi_class="multinomial",random_state=0)
classifier.fit(xtrain,ytrain)
ypred=classifier.predict(xtest)
confusion_matrix(ytest,ypred)
accuracy_score(ytest, ypred)
...
classifier= RandomForestClassifier(n_estimators=100,verbose=1,criterion="entropy")
classifier.fit(xtrain,ytrain)
ypred=classifier.predict(xtest)
confusion_matrix(ytest,ypred)
from sklearn.metrics import accuracy_score
z2=accuracy_score(ytest, ypred)
#%%%%%%%%%%%%5
